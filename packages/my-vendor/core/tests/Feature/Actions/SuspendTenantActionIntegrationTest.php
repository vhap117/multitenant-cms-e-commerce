...
class SuspendTenantActionIntegrationTest extends TestCase
{
    ...
    public function it_logs_error_and_throws_exception_if_suspension_fails()
    {
        ...
        // Note: Similar to ReactivateTenantAction, SuspendTenantAction does NOT wrap 
        // itself in a DB::transaction(), so earlier pipe executions (like session truncation)
        // are permanently committed even if the pipeline later explodes!
    }
}
